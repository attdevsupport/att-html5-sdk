...
public class TestCms_Negative {
		...
		//test code for single test case that exercises negative flow of CMS
		private void Scenario(String url, String numParameter, String messagePlay, String button_1, String selection_2, String button_2, String feature) throws InterruptedException, IOException{
			...
			driver.findElement(By.name("txtNumberToDial")).sendKeys(global.impPhone);
			driver.findElement(By.name(numParameter)).sendKeys(global.impPhone);
			driver.findElement(By.name(messagePlay)).sendKeys(global.mp3Url);
			
			tempElement = driver.findElement(By.name(button_1));
			tempElement.click();
			log.InnerWrite("Negative Flow: CMS Create Session: \n");
			...
			tempElement.click();
			log.InnerWrite("Negative Flow: CMS Send Signal: \n");
			global.ResponseDisplay(url, driver);
