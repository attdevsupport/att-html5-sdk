...
public class WAP {
	...
	private static void Wap_Positive() throws InterruptedException, IOException {
		RESTfulSampleApps.sampleApp.TestWAP.TestWap_Positive wapPos = new RESTfulSampleApps.sampleApp.TestWAP.TestWap_Positive();
	...
	private static void Wap_Negative() throws InterruptedException, IOException {
		RESTfulSampleApps.sampleApp.TestWAP.TestWap_Negative wapNeg = new RESTfulSampleApps.sampleApp.TestWAP.TestWap_Negative();
