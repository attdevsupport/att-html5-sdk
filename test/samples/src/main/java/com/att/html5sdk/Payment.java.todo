...
public class Payment {
	...
	private static void SinglePay() throws InterruptedException, IOException {
		TestPayment.copy.Payment_Single singlepay = new TestPayment.copy.Payment_Single();
	...
	private static void Subscription() throws InterruptedException, IOException {
		TestPayment.copy.Payment_Subscription subscription = new TestPayment.copy.Payment_Subscription();
