...
public class SMS {
	...
	private static void Sms_1() throws InterruptedException, IOException{
		TestSMS.copy.TestSendReceiveSms_Positive sendReceiveSms = new TestSMS.copy.TestSendReceiveSms_Positive();
	...
	private static void Sms_2() throws InterruptedException, IOException{
		TestSMS.copy.TestVoting vote = new TestSMS.copy.TestVoting();
	...
	private static void Sms_1_Negative() throws InterruptedException, IOException {
		TestSMS.copy.TestSendReceiveSms_Negative sendReceiveSms_Neg = new TestSMS.copy.TestSendReceiveSms_Negative();
