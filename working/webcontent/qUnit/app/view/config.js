Ext.define('KitchenSink.view.config', {
	...
	phoneNumberDashes : '425-286-3726',
	...
	phoneNumberParenthesis : '(425)2863726',
	...
	// Personal cell phone, so you can see messages arrive in your inbox. Currently set to a Blackflag phone number, 425-213-7547.
	personalCellPhone : '4252137547',
		
	// Personal email, so I can see messages arrive in my inbox.
	personalEmail : 'ryuichii@isoftstone.com',
		
	// Duplicate email, for another test.
	duplicateEmail : 'ryuichii@isoftstone.com,ryuichii@isoftstone.com',
