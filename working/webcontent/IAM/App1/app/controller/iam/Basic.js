...
Ext.define('SampleApp.controller.iam.Basic', {
     ...
     * This will take the parameters in the send iam form to make a call to sendMms API method.
     * It populates the mmsId field with the IAM Id property obtained in the response.
     */
