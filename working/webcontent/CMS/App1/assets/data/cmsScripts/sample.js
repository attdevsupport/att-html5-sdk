...
var holdMusic		= "http://wdev.code-api-att.com:8181/Tropo/music.mp3";
...
//	say("Your event name is " + result25.name); badChoice
	...
	ask("Press a digit to test the signaling or press pound to skip", {
		...
		onChoice: function (event) {
			...
			say("Waiting for exit signal " + messageToPlay, {
				allowSignals: "exit",
				onSignal: function (event) {
			...
			say("Waiting for stopHold signal" + messageToPlay, {
				allowSignals: "stopHold",
				onSignal: function (event) {
			...
			say("Waiting for DeeQueue signal " + messageToPlay, {
				allowSignals: "dequeue",
				onSignal: function (event) {
