...
Ext.define('KitchenSink.controller.Main', {
    ...
    onApiCall: function(item, info) {
        ...
        this.getNavigationView().push(Ext.create('KitchenSink.view.ApiResults',{
     ...
     * @private 
     */
    onAuthorizationCheck: function(item, scope, options, e) {
        var me = this;
            ...
            failure: function() {
                me.getProvider().authorizeApp({
                    ...
                    failure: function(message) {
                        item.setMasked(false);
                        Ext.Msg.alert('Access denied', message.msg);
                    }
                });
            }
        });
