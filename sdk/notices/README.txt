...
like SMS, Speech, and MMS, in conjunction with the ability to enable direct
carrier billing, provides a multitude of options not normally available to
mobile web application developers.

To get started, extract the documentation from the separately-downloadable
documentation ZIP file, and open docs/index.html in a web browser.
