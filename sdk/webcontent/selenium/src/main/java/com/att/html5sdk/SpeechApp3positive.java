...
/**
 * @class SpeechApp3positive run a simple positive test case for speech to text
 *        App1
 */
public class SpeechApp3positive {
     ...
     * 
     * @param textArea
     *            The DOM name of the HTML element that allows the user to input
    ...
    public TestResult Execute(String textArea, String submitButton,
            String resultWindow, String successText, String logFile)
