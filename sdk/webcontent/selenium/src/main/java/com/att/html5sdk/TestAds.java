...
public class TestAds {
	...
	*/
	public static void Execute(ArrayList<TestResult> results, String logFile) throws InterruptedException, IOException 
	{
		...
		//localResults.add(adsApp1.Execute(Global.phoneNumber,"address", "This is a test message", "message","btnSendMessage", "btnCloseResponse", "smsId","btnGetStatus"));
		//localResults.add(adsApp1.ExecuteGetSMS("btnGetMessages", "btnCloseResponse"));
