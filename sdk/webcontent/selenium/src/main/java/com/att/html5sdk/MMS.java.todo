...
public class MMS {
	...
	private static void Mms_1() throws InterruptedException, AWTException, IOException{
		TestMMS.copy.TestSendMms_Positive sendMms = new TestMMS.copy.TestSendMms_Positive();
	...
	private static void Mms_2() throws InterruptedException, IOException{
		TestMMS.copy.TestCouponMms couponMms = new TestMMS.copy.TestCouponMms();
	...
	private static void Mms_3() throws InterruptedException, AWTException, IOException{
		TestMMS.copy.TestGalleryMms galleryMms = new TestMMS.copy.TestGalleryMms();
	...
	private static void Mms_1_Negative() throws InterruptedException, AWTException, IOException {
		TestMMS.copy.TestSendMms_Negative sendMmsNeg = new TestMMS.copy.TestSendMms_Negative();
