...
public class MMSApp1positive {
    ...
    public TestResult Execute(String phoneNumber, String txtElementPhoneName,
            ...
            String logFile) throws InterruptedException, IOException {

        // Logger log = Log.getLogger();
        Global global = new Global();
        String url = global.MMS1Ruby;
        TestResult testResult = new TestResult(
                "MMS App1 Positive - Select image from Server", url, logFile);
                ...
                if (result.contains("Success: true")) {
                    ...
                    if (messageID.length() < 1)
                        ...
                        wait.until(ExpectedConditions
                                .visibilityOfElementLocated(By.id(btnGetStatus)));
    ...
    /**
     * This test is a single run for MMS which selects a local file as an
     * attachment
     * 
     * @param phoneNumber
     ...
     * @throws IOException
     */
    public TestResult ExecuteUploadTest(String phoneNumber,
            String txtElementPhoneName, String message,
            String txtElementMessageName, String btnSubmit, String btnDone,
            String statusElementName, String btnGetStatus, String logFile)
        ...
        TestResult testResult = new TestResult(
                "MMS App1 Positive - Upload local file to MMS", url, logFile);
        // start and connect to the Chrome browser
        System.setProperty("webdriver.chrome.driver", global.webDriverDir);
        WebDriver driver = new ChromeDriver();
        // driver.manage().timeouts().pageLoadTimeout(10,TimeUnit.SECONDS);
        ...
        try {
            ...
            try {
                ...
                File file = new File(MMSApp1positive.class
