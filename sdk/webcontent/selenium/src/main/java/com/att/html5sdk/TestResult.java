...
/**
 * @class TestResult standardized data for
 */
public class TestResult {
    ...
    private void writeLastAction(Boolean isError) {
        ...
        if (lastAction.length() > 0 && !logAction.equals(lastAction)) {
            ...
            writeToLog(getLabel("Action") + lastAction + success);
        }
    ...
    private void write(String msg, Boolean isError) {
        ...
        if (msg.length() > 0) {
            writeToLog(repeat(" ", labelPad + 3) + msg + "\n");
        }
    }
    ...
    public void setAction(String action) {
        ...
        writeToLog(getLabel("Action") + action + " >> Started");
    }
