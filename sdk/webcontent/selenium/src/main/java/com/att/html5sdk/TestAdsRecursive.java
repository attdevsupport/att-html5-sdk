                    ...
                    for (String ageGroup : AgeGroupList()) {
                        for (String gender : GenderList()) {
                            ...
                            try {
                                ...
                                SelectFromListbox(driver, waitLonger,
                                        "categoryPicker", category);
                                SelectFromListbox(driver, waitLonger,
                                        "userAgentPicker", userAgent);
                                SelectFromListbox(driver, waitLonger,
                                        "ageGroupPicker", ageGroup);
                                SelectFromListbox(driver, waitLonger,
                                        "genderPicker", gender);

                                // submit the speech to text request and process
                                // the response
                                ...
                                // String result =
                                // driver.findElement(By.id("resultsHeader")).getText();
