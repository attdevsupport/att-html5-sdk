var TO = setTimeout(
   function () {
    if (typeof jQuery == "undefined" || typeof Ext == "undefined" || typeof AttApiClient == "undefined") {
        ...
        if (typeof AttApiClient == "undefined") {
                document.write('<p>This AT&T SDK sample requires the AT&T HTML5 SDK file <b>att-api-client.js</b>. Please copy this file from the <b>client</b> folder, to the <b>webcontent/lib</b> folder.<br>');
        }
        if (typeof jQuery == "undefined") {
                document.write('<p>This AT&T SDK sample requires the jQuery library. Please download and copy this file to the <b>webcontent/lib</b> folder.<br>');
        }
        document.write('<p>If you choose to run the Java variant of the included SDK server, you will need to recompile it so that the resulting .war file includes these files.</p></div>');
    }
    clearTimeout(TO);
   }, 4000
);