...
Ext.define('Att.ApiResults', {
    ...
    config: {
    	responseTpl: '<div id="resultsHeader" class="header <tpl if="success == true">success<tpl else>failed</tpl>">Success: {success}</div><div id="results">Server Response:<br/><span>{[JSON.stringify(values.response, null, "  ")]}<span></div>'
    },
