...
Ext.define('KitchenSink.view.MMS', {
    ...
    config: {
        ...
        items: {
            ...
            items:[{
                ...
                items: [
                    {name: 'mmsOne', xtype: 'textfield', label: 'Wireless #1'},
                    {name: 'mmsTwo', xtype: 'textfield', label: 'Wireless #2'}
                ]
            }, {
                xtype: 'button',
                text: 'Send MMS',
    ...
    /**
     * Handler for sendMms button. Pulls the wireless number from the mmsOne text field and calls the doSendMms function.
     */
    onSendMms: function() {
    ...
    /**
     * Pulls the second wireless number from the mmsOne and mmsTwo text fields and calls
