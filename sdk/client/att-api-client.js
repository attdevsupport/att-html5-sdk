...
AttApiClient = (function () {
    ...
    return {
        ...
        /**
         * The Push Notification API is a public release API and framework to provide apps with Notifications of events in various AT&T APIs. This specification provides details about the framework and mechanism to subscribe and receive Push Notifications from various compatible AT&T APIs. This specification also provides a minimum level of detail for the events generated by participating APIs. The actual details of the events would be specific to the AT&T APIs generating those events.
