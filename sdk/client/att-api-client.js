...
AttApiClient = (function () {
    ...
    return {
         ...
         * mechanism to subscribe and receive Push Notifications from various compatible AT&T APIs. This specification
        ...
        Notification: {
            ...
            /**
             * Get the list of current notification events. The events themselves will remain on the app server; use
        ...
        SMS: {
             ...
             *   @param {String} data.addresses Wireless number of the recipient(s). This should be a comma-separated string where each item is either a phone number (including area code) or a short code. A phone number should be preceded by 'tel:', and a short code should be preceded by 'short:'. An example address string illustrating both types is "tel:4258675309,short:123456".
        ...
        MMS: {
             ...
             *   @param {String} params.addresses Wireless number of the recipient(s). This should be a comma-separated string where each item is either a phone number (including area code) or a short code. A phone number should be preceded by 'tel:', and a short code should be preceded by 'short:'. An example address string illustrating both types is "tel:4258675309,short:123456".
        ...
        InAppMessaging: {
             ...
             *   @param {String} data.addresses the message recipients. This should be a comma-separated string where each item is either a phone number (including area code), a short code, or an email address. A phone number should be preceded by 'tel:', and a short code should be preceded by 'short:'. An example address string illustrating all three types is "demo@example.com,tel:4258675309,short:123456".
