...
AttApiClient = (function () {
    ...
    return {
         ...
         * @class AttApiClientNotification
         * @singleton
         */
        Notification: {
            /**
             ...
             * @param {Object} subscription Object containing the subscription parameters
             * @param {String []} subscription.events  List of notification events.  Values are:
             * - TEXT all events relating to SMS
             * - MMS  all events relating to MMS
             * Defaults to all events
             * @param {Number} subscription.expiresIn Lifetime of the subscription in seconds.  Values:
             * - 0 means the subscription never expires
             * - Value between 3600 (1 hour) and 31536000 (1 year)
             * @param {String} [callbackData] Developer specified information returned in the notification callback.
             ...
             * @param {String} [subscriptionId] The subscription identifier.  If omitted, the subscription in the
            ...
            /**
             * Update the subcription details
             * @param {String} [subscriptionId] Identifies the subscription to update.  If omitted, uses the
             ...
             * @param {String} [subscriptionId] Identifies the subscription to delete.  If omitted, the subscription
             ...
             * @params {String} subscriptionId Identifies the subscription.  If omitted, the subscription for the
             * current session will be used.
             * See getNotifcations for return value details.
             */
