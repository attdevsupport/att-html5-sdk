package com.html5sdk.att.servlet.gallery;
...
public class GalleryListener extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        try {
            ...
            FileOutputStream fous = new FileOutputStream(Gallery.GALLERY_FOLDER
                    + random + "." + type);
            fous.write(outFile);
            fous.close();
            String decodedText = "";
            ...
            while (st.hasMoreTokens()) {
                token = st.nextToken();
                paramLinkedMap.put(URLDecoder.decode(
                        token.substring(0, token.indexOf("=")), "UTF-8"),
                        URLDecoder.decode(
            ...
            PrintWriter outWrite = new PrintWriter(new BufferedWriter(
                    new FileWriter(Gallery.GALLERY_FOLDER + random + "." + type
                            + ".txt")), false);
